...
T = {
 ...
 'g_sections': [
  ...
  ('trouble', 'Bir şeyler ters gittiğinde', [
    ...
    '<p><strong>Bir sağlayıcı “Kurulu değil” gösteriyor.</strong> Codex ve Gemini CLI uygulamayla gelir, yani bu uygulamanın kopyasının hasarlı olduğu anlamına gelir: uygulamayı yeniden kur. Claude Code için kartındaki <em>Claude Code kur</em>’a tıkla; kendin kurduysan bir terminal aç, <code>claude --version</code> komutunun çalıştığını kontrol et, sonra Ayarlar › Yapay zekâ sağlayıcıları › Yeniden tara.</p>'
