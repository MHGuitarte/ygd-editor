...
T = {
 ...
 'g_sections': [
  ...
  ('trouble', 'Gdy coś pójdzie nie tak', [
    ...
    '<p><strong>Dostawca pokazuje „Nie zainstalowano”.</strong> Codex i Gemini CLI są dostarczane z aplikacją, więc to znaczy, że kopia aplikacji jest uszkodzona: zainstaluj aplikację ponownie. W przypadku Claude Code kliknij <em>Zainstaluj Claude Code</em> na jego karcie; jeśli to twoja własna instalacja, otwórz terminal, sprawdź, czy <code>claude --version</code> działa, a potem Ustawienia › Dostawcy AI › Skanuj ponownie.</p>'
