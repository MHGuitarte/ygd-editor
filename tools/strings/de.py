...
T = {
 ...
 'need_h': 'Was du brauchst', 'need_p': 'Git auf deinem Computer und ein Konto bei mindestens einem Anbieter. <a href="https://github.com/openai/codex">Codex</a> und <a href="https://github.com/google-gemini/gemini-cli">Gemini CLI</a> stecken nicht im Installer — deshalb ist er klein —: die App lädt den, den du wählst, beim ersten Aufruf herunter (etwa 100 MB für Codex, 20 MB für Gemini CLI) und prüft ihn gegen die Version, mit der dieses Release gebaut wurde, bevor sie ihn ausführt; für <a href="https://docs.anthropic.com/en/docs/claude-code">Claude Code</a>, dessen Lizenz das Mitliefern nicht erlaubt, bietet Einstellungen › KI-Anbieter einen Klick, der Anthropics offiziellen Installer für dich ausführt. Einen Anbieter zu verbinden öffnet dessen Anmeldeseite in deinem Browser. Für Pull Requests: <code>gh</code> von GitHub oder <code>glab</code> von GitLab.',
 ...
 'g_sections': [
  ...
  ('trouble', 'Wenn etwas schiefgeht', [
    ...
    '<p><strong>Ein Anbieter zeigt „Nicht installiert“.</strong> Codex und Gemini CLI werden auf Wunsch heruntergeladen: Klicke auf der Karte auf <em>Herunterladen</em>; schlägt der Download fehl, sagt die Karte warum (offline, oder eine Datei, die nicht zu ihrer Prüfsumme passte und verworfen wurde). Für Claude Code klick auf <em>Claude Code installieren</em> auf seiner Karte; hast du es selbst installiert, öffne ein Terminal, prüfe, dass <code>claude --version</code> funktioniert, und dann Einstellungen › KI-Anbieter › Erneut suchen.</p>'
